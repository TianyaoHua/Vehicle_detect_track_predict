...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "model/maskrcnn/mask_rcnn_coco.h5")
...
class PedestrianDataset(utils.Dataset):
    ...
    def load_pedestrian(self, dataset_dir, subset):
        ...
        class_names = ['person', 'bicycle', 'car', 'motorcycle', 'airplane',
                       ...
                       'teddy bear', 'hair drier', 'toothbrush'] #BG is not included here since it is initialzed in super.
        class_index = 1
        for class_name in class_names:
            self.add_class(class_name, class_index, class_name)
            class_index += 1
